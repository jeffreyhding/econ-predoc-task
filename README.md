...
**Data:**
Individual-level cross-sectional American Community Survey (ACS) 1-Year PUMS data (via [IPUMS USA](https://usa.ipums.org/usa/)) for households in the Philadelphia Metropolitan Area from 2006–2012. A codebook describing all variables is included. Because the ACS is collected annually, variable definitions and coding may change over time.


## 2.  Sankey Diagram Exercise
